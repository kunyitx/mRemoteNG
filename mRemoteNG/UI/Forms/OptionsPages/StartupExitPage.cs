...
public sealed partial class StartupExitPage
{
    ...
    {
        if (chkStartFullScreen.Checked && chkStartMinimized.Checked) chkStartMinimized.Checked = false;
    }

    private void chkStartMinimized_CheckedChanged(object sender, EventArgs e)
    {
        if (chkStartMinimized.Checked && chkStartFullScreen.Checked) chkStartFullScreen.Checked = false;
    }
}