...
public partial class ConnectionTreeWindow
{
        ...
        mMenFavorites.Click += (sender, args) =>
        {
                     ...
                     Runtime.ConnectionsService.ConnectionTreeModel.GetRecursiveFavoriteChildList(node))
            {
                var favoriteMenuItem = new ToolStripMenuItem
                {
                    ...
                    Tag = containerInfo,
                    Image = containerInfo.OpenConnections.Count > 0
                        ? Properties.Resources.Run_16x
    ...
    private void TxtSearch_KeyDown(object sender, KeyEventArgs e)
    {
        ...
        {
            Runtime.MessageCollector.AddExceptionStackTrace("txtSearch_KeyDown (UI.Window.ConnectionTreeWindow) failed",
                ex);
        }
    }
