...
public class CsvConnectionsSerializerMremotengFormat : ISerializer<ConnectionInfo, string>
{
    ...
    private void WriteCsvHeader(StringBuilder sb)
    {
        ...
        sb.Append(
            "Hostname;Port;VmId;Protocol;SSHTunnelConnectionName;OpeningCommand;SSHOptions;PuttySession;ConnectToConsole;UseCredSsp;UseVmId;UseEnhancedMode;RenderingEngine;RDPAuthenticationLevel;" +
