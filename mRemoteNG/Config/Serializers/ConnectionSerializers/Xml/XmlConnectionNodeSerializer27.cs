...
public class XmlConnectionNodeSerializer27 : ISerializer<ConnectionInfo, XElement>
{
    ...
    private void SetElementAttributes(XContainer element, ConnectionInfo connectionInfo)
    {
        ...
        element.Add(new XAttribute("RedirectAudioCapture",
            connectionInfo.RedirectAudioCapture.ToString().ToLowerInvariant()));
        ...
        if (_saveFilter.SaveInheritance)
        {
            ...
            if (inheritance.CacheBitmaps)
                element.Add(new XAttribute("InheritCacheBitmaps",
                    inheritance.CacheBitmaps.ToString().ToLowerInvariant()));
            ...
            if (inheritance.SSHTunnelConnectionName)
                element.Add(new XAttribute("InheritSSHTunnelConnectionName",
                    inheritance.SSHTunnelConnectionName.ToString().ToLowerInvariant()));
            if (inheritance.OpeningCommand)
                element.Add(new XAttribute("InheritOpeningCommand",
                    inheritance.OpeningCommand.ToString().ToLowerInvariant()));
            ...
            if (inheritance.PuttySession)
                element.Add(new XAttribute("InheritPuttySession",
                    inheritance.PuttySession.ToString().ToLowerInvariant()));
            ...
            if (inheritance.AutomaticResize)
                element.Add(new XAttribute("InheritAutomaticResize",
                    inheritance.AutomaticResize.ToString().ToLowerInvariant()));
            if (inheritance.UseConsoleSession)
                element.Add(new XAttribute("InheritUseConsoleSession",
                    inheritance.UseConsoleSession.ToString().ToLowerInvariant()));
            ...
            if (inheritance.RenderingEngine)
                element.Add(new XAttribute("InheritRenderingEngine",
                    inheritance.RenderingEngine.ToString().ToLowerInvariant()));
            ...
            if (inheritance.LoadBalanceInfo)
                element.Add(new XAttribute("InheritLoadBalanceInfo",
                    inheritance.LoadBalanceInfo.ToString().ToLowerInvariant()));
            ...
            if (inheritance.VNCSmartSizeMode)
                element.Add(new XAttribute("InheritVNCSmartSizeMode",
                    inheritance.VNCSmartSizeMode.ToString().ToLowerInvariant()));
            if (inheritance.VNCViewOnly)
                element.Add(new XAttribute("InheritVNCViewOnly",
                    inheritance.VNCViewOnly.ToString().ToLowerInvariant()));
            ...
            if (inheritance.UseEnhancedMode)
                element.Add(new XAttribute("InheritUseEnhancedMode",
                    inheritance.UseEnhancedMode.ToString().ToLowerInvariant()));
        }
    }
}