        ...
        public StatusValue Verify()
        {
            ...
            try
            {
                ...
                _trustProviderErrorCode =
                    NativeMethods.WinVerifyTrust(windowHandle, NativeMethods.WINTRUST_ACTION_GENERIC_VERIFY_V2,
                        trustDataPointer);
            ...
            finally
            {
                ...
                if (trustFileInfoPointer != IntPtr.Zero) Marshal.FreeCoTaskMem(trustFileInfoPointer);
            }
        }
