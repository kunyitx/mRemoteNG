...
public static class MiscTools
{
    ...
    public class YesNoTypeConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            if (string.Equals(value.ToString(), Language.Yes, StringComparison.CurrentCultureIgnoreCase)) return true;

            if (string.Equals(value.ToString(), Language.No, StringComparison.CurrentCultureIgnoreCase)) return false;
