...
public class ConnectionInfo : AbstractConnectionRecord, IHasParent, IInheritable
{
    ...
    [Browsable(false)] public bool IsQuickConnect { get; set; }
    ...
    private void SetVncDefaults()
    {
        ...
        VNCProxyType =
            (ProtocolVNC.ProxyType)Enum.Parse(typeof(ProtocolVNC.ProxyType), Settings.Default.ConDefaultVNCProxyType);
