...
public static class Shutdown
{
    ...
    private static void SaveConnections()
    {
        ...
        lastUpdate = Runtime.ConnectionsService.UsingDatabase
            ? Runtime.ConnectionsService.LastSqlUpdate
            : Runtime.ConnectionsService.LastFileUpdate;
        ...
        if (currentDate >= updateDate) Runtime.ConnectionsService.SaveConnections();
    }
